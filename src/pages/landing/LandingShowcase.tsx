...
export default function LandingShowcase() {
  const variations = [
    ...
    {
      id: 'neo-brutalist-pro',
      name: 'Neo-Brutalist Pro',
      path: '/landing/neo-brutalist-pro',
      tagline: 'Award-winning brutalist + trust',
      description: 'Neo-Brutalist aesthetic enhanced with student showcases, platform transparency, expanded testimonials. Bold + converts.',
      color: '#BFFF00',
      icon: <Star className="w-8 h-8" />,
      targetAudience: 'Gen Z who want distinctive design that actually builds trust',
      keyFeatures: [
        'Student work showcases',
        'Platform UI transparency',
        '3 detailed testimonials',
        'Trust signals + refined glitch',
      ],
    },
    {
      id: 'vapor-studio',
    ...
    },
    {
      id: 'lumora-runway',
      name: 'Lumora Runway',
      path: '/landing/lumora-runway',
      tagline: 'Minimal premium aesthetic',
      description: 'Runway-inspired pure black and white design with SF Pro Display typography, 3D tilt effects on cards, rounded hero section, and minimal clean aesthetic.',
      color: '#ffffff',
      icon: <Play className="w-8 h-8" />,
      targetAudience: 'Gen Z creators who appreciate minimal, high-end premium aesthetics',
      keyFeatures: [
            ...
            <div className="text-center">
              ...
              <div className="grid md:grid-cols-3 gap-8 text-left">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: showcase.textSecondary }}>
                    8 Brutalist + Vapor + Linear + Cosmic + Y2K + 3 Aurora + Neural
                  </p>
                </div>
              </div>
            </div>
